...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="single-entry-header">
		<h1 class="entry-title"><?php the_title(); ?></h1>
			<p><span class="entry-date"><?php echo get_the_date('j \d\e\ F \d\e Y'); ?></span> <span class="entry-author"><?php _e( 'por', 'yoko' ); ?> <?php the_author() ?></span> <?php if ( comments_open() ) : ?> | <?php comments_popup_link( __( '0 comments', 'yoko' ), __( '1 Comment', 'yoko' ), __( '% Comments', 'yoko' ) ); ?><?php endif; ?></p>
